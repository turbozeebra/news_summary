...
You can test the data preparation functions by running python3 

```
python3 test_get_yle_news.py
```
and 
```
python3 remove_markdown_links.py
```

See /tmp directory to inspect how the model behaves.